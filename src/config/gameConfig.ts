...
export const TOOLBAR_MIN_WIDTH = 1500; // room for the category tabs/action buttons row (now including the Background picker + save-state indicator) and the widest brush category row
